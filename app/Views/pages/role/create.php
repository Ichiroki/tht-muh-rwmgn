...
<body>
    ...
    <main class="content">
        <form action="<?= site_url('roles/create') ?>" method="POST" class="form form-input">
            <?= csrf_field() ?>
            <div class="form__field">
                <label for="role_name">
                    <span>Nama Role</span>
                </label>
                <input autocomplete="off" id="role_name" type="text" name="role_name" value="<?= old('role_name') ?>" class="form__input" placeholder="Masukkan Nama Peran / Role" required>
            </div>
